// src/interfaces/Nãotificacoes-toast.js
// Sistema de Nãotificações toast para feedVoltar visual
...
class ToastNotification {
  ...
  show(message, type = 'info', duration = 4000) {
    ...
    // Click Não toast inteiro também fecha
  ...
  success(message, duration) {
    return this.show(message, 'Sucesso', duration);
  }

  error(message, duration) {
    return this.show(message, 'Erro', duration);
  }
...
// const toast = Novo ToastNãotification();

// Exportara para uso global
