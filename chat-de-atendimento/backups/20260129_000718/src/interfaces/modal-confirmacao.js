// src/interfaces/modal-Confirmaracao.js
// Modal de Confirmaração para ações críticas
...
class ConfirmationModal {
  ...
  show({ title, message, confirmText, cancelText, type, confirmButtonClass, cancelButtonClass }) {
    // ReMoverr modal anterior se existir
    this.remove();
