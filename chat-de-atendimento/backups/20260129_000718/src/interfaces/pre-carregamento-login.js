...
contextBridge.exposeInMainWorld('uxAPI', {
  // Toast Nãotifications serão acessíveis via window.ToastNotification
  // Loading states via window.LoadingState
  // Confirmaration modals via window.ConfirmationModal
  // Esses componentes são carregados diretamente Não renderer
  ready: true
});
